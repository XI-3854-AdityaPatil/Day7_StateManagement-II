...
// in day7_demo/test/domain/usecase/login_usecase_test.dart.
...
import 'package:day7_demo/domain/entities/request_entity/login_request_entity.dart'
    as _i6;
import 'package:day7_demo/domain/repository/login_repository.dart' as _i3;
...
class MockLoginRepository extends _i1.Mock implements _i3.LoginRepository {
  ...
  @override
  _i4.Future<_i2.Result<_i5.LoginEntity>> loginApi(
          {required _i6.LoginRequestEntity? loginRequest}) =>
      (super.noSuchMethod(
        Invocation.method(
          #loginApi,
          [],
